...
public extension UserDefaults {
    ...
    /// 获取一个String类型数据
    func axc_strValue(for key: String) -> String? {
        return self[key] as? String
    }
    /// 获取一个UInt类型数据
    func axc_uIntValue(for key: String) -> UInt? {
        return self[key] as? UInt
    }
    /// 获取一个Int类型数据
    func axc_intValue(for key: String) -> Int? {
        return self[key] as? Int
    }
    /// 获取一个Double类型数据
    func axc_doubleValue(for key: String) -> Double? {
        return self[key] as? Double
    }
    /// 获取一个Float类型数据
    func axc_floatValue(for key: String) -> Float? {
        return self[key] as? Float
    }
    /// 获取一个CGFloat类型数据
    func axc_cgFloatValue(for key: String) -> CGFloat? {
