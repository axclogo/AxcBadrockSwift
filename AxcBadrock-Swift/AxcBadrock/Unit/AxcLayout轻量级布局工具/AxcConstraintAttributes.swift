...
internal struct AxcConstraintAttributes : OptionSet, ExpressibleByIntegerLiteral {
    ...
    internal var layoutAttributes:[NSLayoutConstraint.Attribute] {
        ...
        if (self.contains(AxcConstraintAttributes.left)) {
            attrs.append(.left)
        }
        if (self.contains(AxcConstraintAttributes.top)) {
            attrs.append(.top)
        }
        if (self.contains(AxcConstraintAttributes.right)) {
            attrs.append(.right)
        }
        if (self.contains(AxcConstraintAttributes.bottom)) {
            attrs.append(.bottom)
        }
        if (self.contains(AxcConstraintAttributes.leading)) {
            attrs.append(.leading)
        }
        if (self.contains(AxcConstraintAttributes.trailing)) {
            attrs.append(.trailing)
        }
        if (self.contains(AxcConstraintAttributes.width)) {
            attrs.append(.width)
        }
        if (self.contains(AxcConstraintAttributes.height)) {
            attrs.append(.height)
        }
        if (self.contains(AxcConstraintAttributes.centerX)) {
            attrs.append(.centerX)
        }
        if (self.contains(AxcConstraintAttributes.centerY)) {
            attrs.append(.centerY)
        }
        if (self.contains(AxcConstraintAttributes.lastBaseline)) {
            attrs.append(.lastBaseline)
        }
        if (self.contains(AxcConstraintAttributes.firstBaseline)) {
            attrs.append(.firstBaseline)
        }
        if (self.contains(AxcConstraintAttributes.leftMargin)) {
            attrs.append(.leftMargin)
        }
        if (self.contains(AxcConstraintAttributes.rightMargin)) {
            attrs.append(.rightMargin)
        }
        if (self.contains(AxcConstraintAttributes.topMargin)) {
            attrs.append(.topMargin)
        }
        if (self.contains(AxcConstraintAttributes.bottomMargin)) {
            attrs.append(.bottomMargin)
        }
        if (self.contains(AxcConstraintAttributes.leadingMargin)) {
            attrs.append(.leadingMargin)
        }
        if (self.contains(AxcConstraintAttributes.trailingMargin)) {
            attrs.append(.trailingMargin)
        }
        if (self.contains(AxcConstraintAttributes.centerXWithinMargins)) {
            attrs.append(.centerXWithinMargins)
        }
        if (self.contains(AxcConstraintAttributes.centerYWithinMargins)) {
