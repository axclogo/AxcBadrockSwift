...
public class AxcCameraManager: NSObject, AVCaptureFileOutputRecordingDelegate, UIGestureRecognizerDelegate {
    ...
    /// 缩放
    private var zoomScale       = 1.axc_cgFloatValue
    /// 起始缩放
    private var beginZoomScale  = 1.axc_cgFloatValue
    /// 最大缩放
    private var maxZoomScale    = 1.axc_cgFloatValue
    /// 运动管理器
...
//            AxcCacheManager.shared.axc_saveFileCache(newImageData, key: <#T##String#>)
    ...
    func startRecordingVideo() {
        ...
        guard let tempUrl = AxcCacheManager.shared.axc_fileCacheFolderPath("Video").axc_fileUrlPath else { return }
